...
public loggedUser:any;
  ...
  ngOnInit(): void {var userID=localStorage.getItem('userId');    
  this.loggedUserId=parseInt(userID);
  this.loggedUserName=localStorage.getItem('username');
  this.loggedUser=JSON.parse(localStorage.getItem('userModel'));
  if(this.loggedUser!=null){
    this.loggedFullName =this.loggedUser.firstName+' '+this.loggedUser.lastName;
  }
